...
const ForgotPassword = () => {
  ...
  const sendOtp = async () => {
    ...
    setLoading(true);
    try {
      const res = await fetch("https://mbs-uhbg.onrender.com/api/auth/forgot-password", {
        method: "POST",
  ...
  const verifyOtp = async () => {
    ...
    setLoading(true);
    try {
      const res = await fetch("https://mbs-uhbg.onrender.com/api/auth/verify-otp", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
  ...
  const resetPassword = async () => {
    ...
    setLoading(true);
    try {
      const res = await fetch("https://mbs-uhbg.onrender.com/api/auth/reset-password", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
